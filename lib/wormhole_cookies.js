...
WormholeCookies.prototype.save = function(res) {
  var self = this;
...
WormholeCookies.prototype.retrieve = function() {
  var self = this;
...
WormholeCookies.prototype.exist = function() {
  var self = this;
